...
export const SpilioCheckbox = Template.bind({})
SpilioCheckbox.args = {
  children: (
    <span>
      Get a smaller <br /> waist
...
export const DeeplyCheckbox = Template.bind({})
DeeplyCheckbox.args = {
  children: (
    <span>
      Get a smaller <br /> waist
...
export const TestoraCheckbox = Template.bind({})
TestoraCheckbox.args = {
  children: (
    <span>
      Get a smaller <br /> waist
    </span>
  ...
  checkboxBorderRadius: '6px',
  checkboxBorder: '1px solid #e9e9e9',
  checkboxBackgroundActiveColor: '#50AB64',
  reverse: true,
  activeColor: '#17202a',
  border: '1px solid #e9e9e9',
  activeBorder: '1px solid #50AB64',
  iconSrc: checkIconWhite,
  checkboxActiveBorder: '1px solid #50AB64',
}
